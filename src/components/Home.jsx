...
const Home = () => {
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col-reverse sm:grid sm:grid-cols-2 items-center justify-center h-full px-4 md:flex-row">
      <div className="small-screen hidden">
          {/* <img
            src={HeroImage}
            alt="profile"
            className="hidden md:block rounded-2xl mx-auto w-3/3 md:w-full "
          />
          <img
            src={HeroImageSM}
            alt="profile"
